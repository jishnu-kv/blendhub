...
namespace BlendHub.Pages
{
    public static class BlenderPageHelper
    {
        ...
        /// <summary>
        /// Common method to refresh backup/restore/sync items from a version path
        /// </summary>
        public static void RefreshConfigItems(ObservableCollection<ConfigItemViewModel> itemsCollection, string versionPath, 
            BlenderSettingsService blenderService, Action<ConfigItemViewModel> onPropertyChanged, 
            CollectionViewSource groupedSource)
        {
            itemsCollection.Clear();
            var items = blenderService.GetDefaultBackupItems(versionPath);
